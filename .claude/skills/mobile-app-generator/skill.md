...
description: >
  You MUST use this skill when users ask to create, generate, or build a mobile app or H5 application. Triggers: (1) "创建移动端项目" "生成移动端应用" "搭建H5应用" "移动端框架", (2) "搭建xx系统移动端" "搭建xx系统移动端框架" "xx系统移动端", (3) "搭建xx系统" (when context indicates mobile app), (4) Users describe mobile app requirements (bottom navigation, page types, theme colors), (5) Users provide mobile app design mockups for analysis, (6) "移动端原型" "H5项目" "手机端应用", (7) Need a mobile frontend project with Mock data (no backend required). Uses Vue3 + Vant + Vite + TypeScript + Mock.js stack for complete mobile H5 applications.
---
