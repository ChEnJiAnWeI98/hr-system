...
description: >
  You MUST use this skill when users ask to create, generate, or build a website or corporate site.
  Triggers: (1) "创建官网" "生成网站" "搭建官网" "企业官网" "产品官网",
  (2) "搭建xx系统官网" "搭建xx系统前台" "xx系统官网" "xx系统前台",
  (3) "搭建xx系统" (when context indicates website/frontend),
  (4) Users describe website requirements (navigation, page types like home/product/about/news/contact, theme colors),
  (5) Users provide website design mockups for analysis,
  (6) "官网项目" "前台网站" "公司网站",
  (7) Need a website frontend project with Mock data (no backend required).
  Uses Vue3 + Element Plus + Vite + TypeScript + Mock.js stack for complete corporate/product websites.
---
