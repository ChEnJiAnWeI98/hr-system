...
**使用方法：**
```bash
bash .claude/skills/doc-export/export.sh <markdown文件路径> operation-manual
```
...
```bash
# 在项目根目录执行
bash .claude/skills/doc-export/export.sh docs/20260330-危险厂区巡检系统-用户操作手册-V1.0.md operation-manual

# 或在 docs/ 目录执行
cd docs
bash ../.claude/skills/doc-export/export.sh 20260330-危险厂区巡检系统-用户操作手册-V1.0.md operation-manual
```
