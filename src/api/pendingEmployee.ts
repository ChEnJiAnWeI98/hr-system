import type { PendingEmployee, PendingEmployeeListParams } from '@/types/pendingEmployee'
...
// 创建 Mock 函数
const mockFns = createCrudMock<PendingEmployee>(initialData, {
  idField: 'id',
  searchFields: ['employeeName']
})

// 使用 createCrudApi 创建 API 函数
const crudApi = createCrudApi<PendingEmployee>({
  baseUrl: '/admin/onboarding/pending-employees',
  mockFns
})

// 导出 API 函数
export const getList = crudApi.getList
export const getDetail = crudApi.getDetail
